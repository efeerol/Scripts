...
function checkABlaze()
	...
	for i, enemy in pairs(ABlaze) do
		...
		for j, enemyC in pairs(ABlaze) do
			if enemyC~=nil and enemyC.unit~=nil and enemyC.name~=enemy.name and enemyC.unit.dead~=1 and enemyC.unit.visible~=0 and IsInvulnerable(enemyC.unit).status~=3 then
