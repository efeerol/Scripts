	...
	for i = 1, objManager:GetMaxHeroes() do
		...
		if (enemy ~= nil and enemy.team ~= myHero.team) then
			...
			if enemy.name == 'Xerath' then
				...
				table.insert(skillshotArray,{name= enemy.SpellNameW, shot=0, lastshot = 0, skillshotpoint = {}, maxdistance = 950, type = 1, radius = 100, color= 0xFFFFFF00, time = 1, isline = true, p1x =0, p1y =0 , p1z =0 , p2x =0, p2y =0 , p2z =0 })
