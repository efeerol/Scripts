...
local EnemyIndex = 1
---------- CONFIG ----------
local Harass_Mode = 1 -- Harassmode on gamestart [1=Q, 2=QW, 3=QE, 4=QEW, 5=IQEW, 6=EQ, 7=EQW, 8=IEQW]
local Combo_Mode = 3 -- Combomode on gamestart [1=QEWR, 2=EQWR, 3=IQEWR, 4=IEQWR]
